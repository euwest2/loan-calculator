...
if option == "n":
    loan_prin = float(st.text_input("Enter the loan principal: "))
    mon_pay = float(st.text_input("Enter the monthly payment: "))
    loan_int = float(st.text_input("Enter the loan interest: ")) / 1200
...
if option == "a":
    loan_prin = float(st.text_input("Enter the loan principal: "))
    num_periods = float(st.text_input("Enter the number of periods: "))
    loan_int = float(st.text_input("Enter the loan interest: ")) / 1200
...
if option == "p":
    mon_pay = float(st.text_input("Enter the annuity payment: "))
    num_periods = float(st.text_input("Enter the number of periods: "))
    loan_int = float(st.text_input("Enter the loan interest: ")) / 1200
